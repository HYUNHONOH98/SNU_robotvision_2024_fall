...
home_dir = "/home/hyunho/sfda"#"/home/hyunho/sfda"
exp_dir = "/home/hyunho/sfda/exp/GAN"#"/home/hyunho/sfda/exp/rotation"
debug = False
...
for epoch in range(num_epochs):
    ...
    # 손실 계산 (세그멘테이션 + 회전 검출)
        ...
        if iter % 100 == 0:
            print(f"iter : {iter}, g_loss : {round(G_loss.item(), 2)}, d_loss : {round(D_loss.item(), 2)}")
